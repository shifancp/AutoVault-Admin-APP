...
class CallList extends StatelessWidget {
  ...
  static const routeName = '/callreq';
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        trailing: IconButton(
                          ...
                          onPressed: () {
                            moveItemToCompletedCalls(itemSnap.reference);
                          },
                        ),
                      );
                    });
  ...
  Future<void> moveItemToCompletedCalls(DocumentReference callReference) async {
    try {
      // Get the data from the 'testdrives' document
      DocumentSnapshot callSnapshot = await callReference.get();
