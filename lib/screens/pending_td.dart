...
class PendingTestDrives extends StatelessWidget {
  const PendingTestDrives({super.key});
  static const routeNmae = '/pendingtd';
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Pending Test Drives'),
        ),
        body: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collectionGroup('testdrives')
              .snapshots(),
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return TestDriveCard(
                  ...
                  ftn: () {
                    moveItemToCompletedTestDrives(itemSnap.reference);
                  },
                );
              },
            );
